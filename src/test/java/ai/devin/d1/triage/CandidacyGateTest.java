...
class CandidacyGateTest {
    ...
    private final D1Properties props = new D1Properties();
    ...
    void criteriaWithoutVerificationCommandsAreNotACandidate() {
        SuccessCriteria noProof = new SuccessCriteria(
                true, 0.95, "bump the dependency", List.of("advisory is gone"), List.of(), List.of(), "low",
                List.of(), "");
    ...
    void lowConfidenceIsNotACandidate() {
        SuccessCriteria unsure = new SuccessCriteria(
                true, 0.4, "maybe", List.of("advisory is gone"), List.of("npm audit"), List.of(), "medium",
                List.of(), "");
    ...
    void blockingUnknownsSendTheIssueBackToAHuman() {
        SuccessCriteria unknown = new SuccessCriteria(
                true, 0.9, "unclear", List.of("x"), List.of("npm test"), List.of(), "low",
    ...
    void anExplicitlyNonAutomatableVerdictIsHonoured() {
        SuccessCriteria refused = new SuccessCriteria(
                false, 0.9, "needs a product decision", List.of("x"), List.of("npm test"), List.of(), "high",
                List.of(), "requires choosing a new chart default");
